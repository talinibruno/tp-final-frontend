    ...
    <>
      {
        ...
        <section className="cont-popup">
          <div className="popup">
            <h2>Configuración</h2>
            <hr className="popup-divider"></hr>
            <h3>Tema del chat</h3>
            <button onClick={toggleTheme} className="popup-change-theme" >
              {
                theme === 'light' ?
                  (
                    <>
            ...
            <hr className="popup-divider"></hr>
            <h3>Cambiar Apodo</h3>
            <p className="popup-coming-soon">¡Próximamente!</p>
            <hr className="popup-divider"></hr>
            <h3>Cambiar Fondo</h3>
            <p className="popup-coming-soon">¡Próximamente!</p>
            <hr className="popup-divider"></hr>

            <button className="popup-close" onClick={handleClick} >Cerrar</button>
          </div>
        </section>
      }
      ...
      <div className="chat">
        <header className="chat-header">
          ...
          <div className="chat-actions">
            <button title="Camera" className="btn-chat-camera" >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-camera-fill" viewBox="0 0 16 16">
                <path d="M10.5 8.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0" />
                <path d="M2 4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.172a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 9.172 2H6.828a2 2 0 0 0-1.414.586l-.828.828A2 2 0 0 1 3.172 4zm.5 2a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1m9 2.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0" />
              </svg>
            </button>
            <button title="Gallery" className="btn-chat-gallery">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-image-fill" viewBox="0 0 16 16">
                <path d="M.002 3a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-12a2 2 0 0 1-2-2zm1 9v1a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9.5l-3.777-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062zm5-6.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0" />
              </svg>
            </button>
            <button onClick={handleClick} title="Settings" className="btn-chat-settings">
            ...
            <button onClick={() => { navigate("/help") }} title="Help" className="btn-chat-help">
